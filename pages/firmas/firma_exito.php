...
<head>
    ...
    * {
    ...
    /* NUEVO estilo para banner de Éxito con botón */
.mini-banner-exito {
    width: 120px;
...
<body>
    ...
    <div class="mini-banner-exito">
    <a href="https://allcms.es/caso-de-exito/unificacion-y-automatizacion-de-la-tesoreria-global-el-caso-de-exito-de-exolum/?utm_source=Mail&utm_medium=Firma&utm_campaign=CE_Exolum&utm_id=PB" target="_blank">
        <img src="gif/exito.png" alt="Caso de Éxito - Exolum">
